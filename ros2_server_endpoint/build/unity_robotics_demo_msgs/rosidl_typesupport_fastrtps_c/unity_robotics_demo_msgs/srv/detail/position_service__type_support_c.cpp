...
static size_t _PositionService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unity_robotics_demo_msgs__srv__PositionService_Request(
...
static size_t _PositionService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unity_robotics_demo_msgs__srv__PositionService_Response(
    full_bounded, is_plain, 0);
